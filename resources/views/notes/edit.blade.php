        ...
        <div class="row">
            <div class="col-md-5 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('notes.index') }}" enctype="multipart/form-data">
                        Back</a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Note:</strong>
                        <input type="number" name="note" class="form-control" value="{{$notes->note}}" placeholder="Note" id="note">
                        @error('note')
